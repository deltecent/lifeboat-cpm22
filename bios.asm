...
ldb5ch:
	...
	out	008hvv		;db5e	d3 08 	. . 
	lda	0df9bh		;db60	3a 9b df 	: . . 
	out	008hvv		;db63	d3 08 	. . 
	in	008h		;db65	db 08 	. . 
	ani	008h		;db67	e6 08 	. . 
