;--------------------------------------------------------------------
;
;   Boot loader for MITS (Lifeboat) CP/M 2.2 on a 88-DCCD Floppy
;
...
memSize	equ	0		;memory size in K bytes (0 for relocatable)
...
;
	...
	xra	a		;???
	sta	biosBase+089dh	;???
	lda	biosBase+04ffh	;flag to leave interrupts disabled in the BIOS
